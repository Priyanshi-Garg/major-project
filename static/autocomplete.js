new autoComplete({
  ...
  selector: "#autoComplete1", // Input field selector              | (Optional)
  ...
  noResults: () => {
    ...
    document.querySelector("#autoComplete1_list").appendChild(result);
  },
  onSelection: (feedback) => {
    // Action script onSelection event | (Optional)
    document.getElementById("autoComplete1").value = feedback.selection.value;
  },
});
